...
const CountryDetailPage = () => {
  ...
  return (
    <div className="p-4 md:p-16 lg:px-24 pt-4 h-[calc(100vh-5rem)] font-semibold bg-very-light-gray dark:bg-very-dark-blue-dm text-very-dark-blue-lm dark:text-white">
      <Button title={"Back"} isBack={true} />

      {loading || !singleCountry ? (
        <CardSkeleton />
      ) : (
